...
fn main() {
    println!("[3, 4] target 3 = {:?}", find_first_last_index(&vec![3, 4], 3));
    println!("[3, 4] target 6 = {:?}", find_first_last_index(&vec![3, 4], 6));
    println!("[5,7,7,8,8,10] target 8 = {:?}", find_first_last_index(&vec![5, 7, 7, 8, 8, 10], 8));
    println!("[5,7,7,8,8,10] target 9 = {:?}", find_first_last_index(&vec![5, 7, 7, 8, 8, 10], 9));
    println!("[5,7,7,8,8,9,10] target 9 = {:?}", find_first_last_index(&vec![5, 7, 7, 8, 8, 9, 10], 9));
    println!("[5,7,7,8,8,9,9] target 9 = {:?}", find_first_last_index(&vec![5, 7, 7, 8, 8, 9, 9], 9));
}